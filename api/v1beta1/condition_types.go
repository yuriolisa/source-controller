...
const (
	...
	// This is a "negative polarity" or "abnormal-true" type, and is only present on the resource if True.
	...
	// BuildFailedCondition indicates a transient or persistent build failure of the Artifact using collected Source(s)
	// and the definitions from the resource.
	// If True, the Artifact available for the Source may be outdated, and out of sync with the definitions for the
